...
var sources = {
	blank: 'data:image/png;base64,' + fs.readFileSync(__dirname + '/static/img/blank.png', 'base64'),
	sprite: 'data:image/png;base64,' + fs.readFileSync(__dirname + '/static/img/sprite.png', 'base64')
};
function css(string) {
